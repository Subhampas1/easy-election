"""
prompt_builder.py — System Prompts for Citizen Election Assistant
...
def build_ballot_explainer_prompt(stage: str) -> str:
    ...
    description: str = stage_descriptions.get(stage.lower(), "the general Indian election voting process")
    return (
        f"{SYSTEM_PROMPT}\n\n"
        f"## Task\n"
...
PROMPT_REGISTRY: dict[str, dict[str, str]] = {
    "roadmap": {"builder": "build_roadmap_prompt", "description": "Generates a personalized voter registration checklist.", "required_fields": "state, age"},
    "myth_check": {"builder": "build_myth_check_prompt", "description": "Fact-checks an election-related claim.", "required_fields": "claim"},
    "ballot_explainer": {"builder": "build_ballot_explainer_prompt", "description": "Explains a stage of the EVM/VVPAT process.", "required_fields": "stage"},
    "eligibility": {"builder": "build_eligibility_prompt", "description": "Checks voter eligibility and advises next steps.", "required_fields": "age, has_voter_id"},
}
